...
IX\<esc>`dma`Imd`Jmc`Kmb`ame`dV}dggmd`cV}dggmc`ema`Nme`Omd`Pmc`Qmb`amg`emR`fmQ`bmP`cmO`dmN`Qmb`RmcGo\<esc>ma`amd`byy`dP`cyy`dP`d{jmd`dJxx^x:s/\\(x\\{32}\\)*//g\<cr>
IX\<esc>`dma`Nmd`Omc`Pmb`ame`fV}dggmf`emR`gmQ`bmP`cmO`dmN`Qmb`RmcGo\<esc>ma`amd`byy`dP`cyy`dP`d{jmd`dJxx^x:s/\\(x\\{32}\\)*//g\<cr>
IX\<esc>`dma`Nmd`Omc`Pmb`amf`eV}dggme`gV}dggmg`fyy`dP`fV}dggmf`b1jmb`c1jmc`d{jmdxJ`dma`Smg`Tmf`Ume`Vmd`Wmc`Xmb`amf`fmZ`bmY`cmX`Zmb`bmW`bmV`Wmb`bV}yGpma`Vmb`amc`c:s/X\\(x\\{23}\\)\\?/X/g\<cr>
:s/X\\(x\\?\\)x*/X\\1/g\<cr>
j:s/X\\(x\\{30}\\)\\?/X/g\<cr>
:s/X\\(x\\?\\)x*/X\\1/g\<cr>
j:s/X\\(x\\{17}\\)\\?/X/g\<cr>
